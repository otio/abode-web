...
.formulate-input[data-classification='text'] input {
  ...
  border: 1px solid rgba(205, 21, 21, 0.6);
...
.formulate-input[data-classification='button'] button[disabled]:active {
  background-color: rgba(205, 21, 21, 0.6);
  border-color: rgba(205, 21, 21, 0.6);
}
...
.formulate-input[data-classification='select'] .formulate-input-element:before {
  ...
  width: 0;
  height: 0;
  border-color: rgba(205, 21, 21, 0.6) transparent transparent;
  border-style: solid;
